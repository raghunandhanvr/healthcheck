...
const ArrowBigDownDashIcon = forwardRef<ArrowBigDownDashIconHandle, ArrowBigDownDashIconProps>(
    ...
    return (
      ...
      >
        ...
        >
          ...
          <motion.path d="M15 9v3h4l-7 7-7-7h4V9z" variants={arrowVariants} animate={controls} />
        </svg>
      </div>
    )
  }
