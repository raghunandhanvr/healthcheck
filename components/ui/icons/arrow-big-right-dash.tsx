...
const ArrowBigRightDashIcon = forwardRef<ArrowBigRightDashIconHandle, ArrowBigRightDashIconProps>(
    ...
    return (
      ...
      >
        ...
        >
          ...
          <motion.path d="M9 9h3V5l7 7-7 7v-4H9V9z" variants={arrowVariants} animate={controls} />
        </svg>
      </div>
    )
  }
