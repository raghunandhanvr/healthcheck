...
const ArrowBigRightIcon = forwardRef<ArrowBigRightIconHandle, ArrowBigRightIconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    return (
      ...
      >
        ...
        >
          <motion.path d="M6 9h6V5l7 7-7 7v-4H6V9z" variants={pathVariants} animate={controls} />
        </svg>
      </div>
    )
  }
