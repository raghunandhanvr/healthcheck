...
const MapPinMinusInsideIcon = forwardRef<MapPinMinusInsideIconHandle, MapPinMinusInsideIconProps>(
    ...
    return (
      ...
      >
        ...
        >
          ...
          <motion.path d="M9 10h6" variants={minusVariants} initial="normal" animate={controls} />
        </motion.svg>
      </div>
    )
  }
