    ...
    return (
      ...
      >
        ...
        >
          ...
          <motion.path d="M8 10h.01" variants={dotVariants} animate={controls} custom={0} />
          <motion.path d="M12 10h.01" variants={dotVariants} animate={controls} custom={1} />
          <motion.path d="M16 10h.01" variants={dotVariants} animate={controls} custom={2} />
        </svg>
      </div>
    )
  }
