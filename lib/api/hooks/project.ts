...
import { useApi, UseApiOptions, useLazyApi, useMutation } from "../hooks"
...
export function useProject(id: string, options?: UseApiOptions) {
  return useApi<Project>(() => (id ? API_ROUTES.PROJECT.GET(id) : ""), {
    ...options,
...
export function useProjectHealth(id: string, options?: UseApiOptions) {
  return useApi<HealthCheckResult[]>(() => (id ? API_ROUTES.PROJECT.HEALTH(id) : ""), {
    ...options,
    enabled: Boolean(id) && (options?.enabled ?? true),
...
export function useProjectMonitoring(id: string, options?: UseApiOptions) {
  return useApi<MonitoringConfig>(() => (id ? API_ROUTES.PROJECT.MONITORING(id) : ""), {
    ...options,
    enabled: Boolean(id) && (options?.enabled ?? true),
  })
}
...
export function useProjectBackups(id: string, options?: UseApiOptions) {
  return useApi<Backup[]>(() => (id ? API_ROUTES.PROJECT.BACKUPS(id) : ""), {
    ...options,
    enabled: Boolean(id) && (options?.enabled ?? true),
  })
}
